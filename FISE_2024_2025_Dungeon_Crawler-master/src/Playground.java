...
public class Playground {
    // Création d'une liste pour stocker tous les sprites de l'environnement
    private ArrayList<Sprite> environment = new ArrayList<>();

    public Playground (String pathName){
        try{
            // Chargement des images des différents types de sprites
            ...
            // Dimensions des images pour chaque élément du jeu
            ...
            // Lecture du fichier de niveau (pour lire la map)
            BufferedReader bufferedReader = new BufferedReader(new FileReader(pathName));
            String line=bufferedReader.readLine();
            int lineNumber = 0;
            int columnNumber = 0;
            while (line!= null){
                // Lecture ligne par ligne pour ajouter les sprites
                for (byte element : line.getBytes(StandardCharsets.UTF_8)){
                    switch (element){
                        // 'T' représente un arbre
                        ...
                        case ' ' : environment.add(new Sprite(columnNumber*imageGrassWidth,
                            ...
                            break;
                        // 'P' représente un piège
                        case 'P' : environment.add(new Sprite(columnNumber*imageGrassWidth,
                                lineNumber*imageTrapHeight, imageTrap, imageTrapWidth, imageTrapHeight));
                            break;
                        // 'R' représente une roche
    ...
    public ArrayList<Sprite> getSolidSpriteList(){
        // Création d'une liste dans laquelle on ajoute les sprite
